...
def ffb(ids,names,passlist):
    ...
    # 'cookie': 'datr=7i9FZfB4lBkOrFK78-Wiojt2; sb=7i9FZdj5E9tOsaSkgLvhmKeG; m_pixel_ratio=1.8000000715255737; wd=400x750; fr=0XTOvazWqz8SsAo8H..BlRS_u.iN.AAA.0.0.BlRnFy.AWUQxtLEjqQ',
